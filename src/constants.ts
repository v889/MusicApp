...
export const playListData: Track[] = [
    {
      ...
      url: require('./assests/audio/one.mp3'),
    },
    {
      id: 2,
      ...
      url: require('./assests/audio/two.mp3'),
    },
    {
      id: 3,
      title: 'Kesariya',
      ...
      url: require('./assests/audio/three.mp3'),
    },
    {
      id: 4,
      title: 'Title Track',
      ...
      url: require('./assests/audio/four.mp3'),
    },
    {
      id: 5,
      title: 'Besharam Rang',
      ...
      url: require('./assests/audio/five.mp3'),
    },
  ];
